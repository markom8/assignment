...
public class AssignmentPrimer5Test {
    ...
    /*
    5.	Unaprediti API endpoint iz tačke 1 tako da se rezultati mogu slati parcijalno
    (npr. samo jedna utakmica, više utakmica, sve utakmice jedne grupe itd.)
    ...
    @Test
    @Transactional
    public void testCreateOrUpdateResultReturnTablePrimer5() throws Exception {
